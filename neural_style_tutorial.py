...
imsize = 512 if use_cuda else 64  # use small size if no gpu
...
style_img = image_loader("/Users/andrewsilva/Desktop/ross_big.jpg").type(dtype)
content_img = image_loader("/Users/andrewsilva/Desktop/kayla.jpg").type(dtype)
...
imsave('/Users/andrewsilva/Desktop/ross_kayla.jpg', output)
